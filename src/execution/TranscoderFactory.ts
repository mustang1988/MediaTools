...
export class TranscoderFactory {
    static ToMp4(input: string, output: string, bin?: string): ITranscoder {
    ...
    static ToWebM(input: string, output: string, bin?: string): ITranscoder {
    ...
    static ToHLS(input: string, output: string, bin?: string): ITranscoder {
